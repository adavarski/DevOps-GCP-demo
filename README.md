...
- [Terraform GCP VM (example NGINX server)](https://github.com/adavarski/DevOps-GCP-demo/tree/main/VM/)

- [Terraform GKE + k8s-manifests](https://github.com/adavarski/DevOps-GCP-demo/tree/main/GKE/) 
